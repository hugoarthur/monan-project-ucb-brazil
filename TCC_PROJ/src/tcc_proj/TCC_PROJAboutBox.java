...
public class TCC_PROJAboutBox extends javax.swing.JDialog {

    public TCC_PROJAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(tcc_proj.TCC_PROJApp.class).getContext().getResourceMap(TCC_PROJAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(tcc_proj.TCC_PROJApp.class).getContext().getActionMap(TCC_PROJAboutBox.class, this);
